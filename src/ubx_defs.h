...
UBX_CFG_PRT(cfg_prt_uart1_ubxnmea, 0x01,0x00,0x00,0x00,0xD0,0x08,0x00,0x00,0x80,0x25,0x00,0x00,0x07,0x00,0x03,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-PRT Target=USB ProtocolIn=UBX+NMEA+RTCM2 ProtocolOut=UBX ExtendedTxTimeout=off TxReadyFeature=off
UBX_CFG_PRT(cfg_prt_usb_ubx, 0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0x00,0x01,0x00,0x00,0x00,0x00,0x00)
...
UBX_CFG_PRT(cfg_prt_usb_ubxnmea, 0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0x00,0x03,0x00,0x00,0x00,0x00,0x00)
...
UBX_CFG_MSG(cfg_msg_nmea_gga_off, 0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-01-NMEA-GxGLL I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_gll_off, 0xF0,0x01,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-02-NMEA-GxGSA I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_gsa_off, 0xF0,0x02,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-03-NMEA-GxGSV I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_gsv_off, 0xF0,0x03,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-04-NMEA-GxRMC I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_rmc_off, 0xF0,0x04,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-05-NMEA-GxVTG I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_vtg_off, 0xF0,0x05,0x00,0x00,0x00,0x00,0x00,0x00)
