...
UBX_CFG_MSG(cfg_msg_nmea_zda_on, 0xF0,0x08,0x01,0x01,0x01,0x01,0x01,0x00)

// UBX-CFG-MSG Message=F0-09-NMEA-GxGBS I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_gbs_off, 0xF0,0x09,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-0A-NMEA-GxDTM I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_dtm_off, 0xF0,0x0A,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-0D-NMEA-GxGNS I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_gns_off, 0xF0,0x0D,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-0E-NMEA-GxTHS I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_ths_off, 0xF0,0x0E,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-0F-NMEA-GxVLW I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_vlw_off, 0xF0,0x0F,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-10-NMEA-GxUTC I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_utc_off, 0xF0,0x10,0x00,0x00,0x00,0x00,0x00,0x00)

// UBX-CFG-MSG Message=F0-0B-NMEA-GxRLM I2C=off UART1=off UART2=off USB=off SPI=off
UBX_CFG_MSG(cfg_msg_nmea_rlm_off, 0xF0,0x0B,0x00,0x00,0x00,0x00,0x00,0x00)
